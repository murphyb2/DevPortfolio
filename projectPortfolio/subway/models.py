...
class MapPrep(models.Model):
    ...
    def update_map(self):
        ...
        exist = os.path.exists(os.path.join('', f'subway/final.csv'))
        if(not exist):
            ...
            final_df.to_csv("subway/final.csv")
        else:
            final_df = pd.read_csv(os.path.join('', f'subway/final.csv'))
        ...
        m.save(os.path.join('', f'subway/templates/heatmap.html'))
